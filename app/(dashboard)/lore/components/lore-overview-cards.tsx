/**
 * Lore Overview Cards - Entity type-based cards with recent items
 */
...
interface LoreOverviewCardsProps {
  statsByType: Record<string, number>
  recentByType: Record<string, RecentLore[]>
  unlinkedCount: number
  recentUnlinked: RecentLore[]
}

export function LoreOverviewCards({ 
  statsByType, 
  recentByType,
  unlinkedCount,
  recentUnlinked 
}: LoreOverviewCardsProps) {
  ...
  const entityTypes = [
    { 
      ...
      labelRu: 'Герои', 
      labelEn: 'Heroes',
      descRu: 'Лор о ключевых персонажах',
      descEn: 'Lore about key characters',
    ...
    { 
      ...
      labelRu: 'Юниты', 
      labelEn: 'Units',
      descRu: 'Лор о боевых единицах',
      descEn: 'Lore about combat units',
    ...
    { 
      ...
      labelRu: 'Фракции', 
      labelEn: 'Factions',
      descRu: 'Лор о расах и группировках',
      descEn: 'Lore about races and groups',
    ...
    { 
      ...
      labelRu: 'Заклинания', 
      labelEn: 'Spells',
      descRu: 'Лор о магии и способностях',
      descEn: 'Lore about magic and abilities',
    ...
    { 
      ...
      labelRu: 'Артефакты', 
      labelEn: 'Artifacts',
      descRu: 'Лор о предметах и экипировке',
      descEn: 'Lore about items and equipment',
    ...
    { 
      ...
      labelRu: 'Локации', 
      labelEn: 'Locations',
      descRu: 'Лор о местах и территориях',
      descEn: 'Lore about places and territories',
                ...
                {recent.map(entry => (
                  ...
                  >
                    <span className="text-sm text-white truncate flex items-center gap-2">
                      <BookOpen size={12} strokeWidth={1.5} className="text-white/40 flex-shrink-0" />
                      {entry.title}
                    </span>
                    <span className="text-xs text-white/30 flex-shrink-0 ml-2">{formatRelativeTime(entry.updatedAt)}</span>
                  </Link>
                ))}
              </div>
            ) : (
