...
export const translations = {
  ...
  thoughts: {
    ...
    linkedEntity: { en: 'Linked entity', ru: 'Связь с объектом' },
  ...
  filters: {
    ...
    entityType: { en: 'Entity Type', ru: 'Тип объекта' },
  },
  ...
  // Entities page
  entities: {
    title: { en: 'Game Entities', ru: 'Игровые объекты' },
    newEntity: { en: 'New Entity', ru: 'Новый объект' },
    backToEntities: { en: 'Back to entities', ru: 'Назад к объектам' },
    backToEntity: { en: 'Back to', ru: 'Назад к' },
    noEntities: { en: 'No entities found', ru: 'Объекты не найдены' },
    concepts: { en: 'concepts', ru: 'концептов' },
    loreEntries: { en: 'lore entries', ru: 'записей лора' },
    thoughtsCount: { en: 'thoughts', ru: 'мыслей' },
    category: { en: 'Entity category', ru: 'Категория объекта' },
    ...
    createEntity: { en: 'Create Entity', ru: 'Создать объект' },
    saveChanges: { en: 'Save Changes', ru: 'Сохранить изменения' },
    deleteEntity: { en: 'Delete entity', ru: 'Удалить объект' },
    deleteConfirmTitle: { en: 'Delete Entity', ru: 'Удаление объекта' },
    deleteConfirmText: { en: 'This action cannot be undone', ru: 'Это действие нельзя отменить' },
    deleteConfirmQuestion: { en: 'Are you sure you want to delete', ru: 'Вы уверены, что хотите удалить объект' },
    ...
    forEntity: { en: 'For entity', ru: 'Для объекта' },
  ...
  dashboard: {
    ...
    gameEntities: { en: 'Game Entities', ru: 'Игровые объекты' },
    conceptArts: { en: 'Concept Arts', ru: 'Концепт-арты' },
  ...
  conceptArt: {
    ...
    linkEntity: { en: 'Link to entity', ru: 'Привязка к объекту' },
    selectEntity: { en: 'Select entity', ru: 'Выбрать объект' },
    ...
    batchUploadDesc: { en: 'Upload multiple concept arts for one entity', ru: 'Загрузите несколько концепт-артов для одного объекта' },
  ...
  form: {
    ...
    entity: { en: 'Link to entity', ru: 'Связь с объектом' },
  ...
  lore: {
    ...
    primaryEntity: { en: 'Primary Entity', ru: 'Основной объект' },
    linkedEntities: { en: 'Linked Entities', ru: 'Связанные объекты' },
    addLinkedEntity: { en: 'Add linked entity', ru: 'Добавить связь' },
    selectPrimaryEntity: { en: 'Select primary entity', ru: 'Выбрать основной объект' },
